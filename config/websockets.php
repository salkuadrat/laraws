...
return [
    ...
    'apps' => [
        [
            'id' => env('WEBSOCKETS_ID', 'local'),
            'key' => env('WEBSOCKETS_KEY', 'local'),
            'secret' => env('WEBSOCKETS_SECRET', 'secret'),
            'name' => env('APP_NAME', 'Laravel'),
            'capacity' => env('WEBSOCKETS_CAPACITY', null),
            'enable_client_messages' => env('WEBSOCKETS_CLIENT_MESSAGES', false),
            'enable_statistics' => env('WEBSOCKETS_STATISTICS', true),
        ],
    ],
    ...
    'statistics' => [
         ...
         */
        'delete_statistics_older_than_days' => env('WEBSOCKETS_STATISTICS_EXPIRATION', 60),

        /*
         * Use an DNS resolver to make the requests to the statistics logger
         * default is to resolve everything to 127.0.0.1.
         */
        'perform_dns_lookup' => env('WEBSOCKETS_STATISTICS_DNS_LOOKUP', false),
    ],
